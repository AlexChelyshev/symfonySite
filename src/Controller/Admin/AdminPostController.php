...
use App\Repository\PostRepositryInterface;
...
class AdminPostController extends AdminBaseController
{
    ...
    public function __construct(CategoryRepositoryInterface $categoryRepository, PostRepositryInterface $postRepository)
    {
